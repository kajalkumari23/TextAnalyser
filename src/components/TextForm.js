...
export default function TextForm(props) { 
    ...
    return (
        ...
        <div className='container' style={{ color:props.mode === 'dark'?'white':'black'}}> 
            ...
            <button className="btn btn-info mx-2"  onClick={handleExtraSpace}>Remove space</button>
            <button className="btn btn-info mx-2" onClick={buttonClick}>Convert to TitleCase</button>
            <button type="submit" onClick={speak} className="btn btn-info mx-2">Speak</button>
            <button className="btn btn-info mx-2" onClick={handleReverse}>Reverse</button>
            <button className="btn btn-info mx-2" onClick={handleitalic}>italic</button>
            {/* mx-2 is bootstrap class for margin in x */}
